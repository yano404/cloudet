...
REDUCTION_OPS: tuple[ReductionOpDef, ...] = (
    ...
    ReductionOpDef(
        ...
        "point",
        operands=(
            OperandField("point", "point", "rd_rotp_point", "Point"),
            OperandField("line", "line", "rd_rotp_line", "Axis"),
        ),
        scalars=(
            ScalarField(
                "angle_deg",
        ...
        missing_msg="rotate point needs a point and an axis",
        hint="Rotate the point about the axis. Positive angle follows the right-hand rule.",
    ),
    ReductionOpDef(
        "rotate_line_about_line",
        "rotate_line_about_line",
        "Rotate line about axis",
        "Rotate line",
        "line",
        "line",
        operands=(
            OperandField("line", "line", "rd_rotl_line", "Line"),
            OperandField("axis", "line", "rd_rotl_axis", "Axis"),
        ),
        scalars=(
            ScalarField(
                "angle_deg",
        ...
        missing_msg="rotate line needs a line and an axis",
        operands_must_differ=True,
        hint="Rotate the line rigidly about another axis. Positive angle follows the right-hand rule.",
    ),
    ReductionOpDef(
